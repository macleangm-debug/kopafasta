...
return [
    ...
    'privacy' => [
        ...
        'intro' => 'This Policy explains how :brand (“Kopafasta”, “we”, “us”) processes personal data for microfinance membership, lending, payments, and related services under the Personal Data Protection Act (PDPA) of the United Republic of Tanzania and related regulations.',
        'sections' => [
            ['Who we are', 'We are the data controller for borrower and member accounts on the Kopafasta digital lending platform operated by :brand. Contact: :email.'],
            ['Legal basis (PDPA)', 'We process personal data where necessary to perform a contract with you (membership, loans, repayments), to comply with legal obligations (KYC/AML, BoT, credit reporting), with your consent where required (e.g. biometric face capture and optional marketing), and for legitimate interests that do not override your rights (fraud prevention, platform security).'],
            ['Sensitive personal data', 'Face verification images and related biometric identifiers are treated as sensitive personal data under the PDPA. We process them only with your prior consent for identity verification and underwriting, or where another PDPA exception applies (e.g. legal compliance). You may withdraw consent for future biometric capture; withdrawal does not affect processing already lawfully completed.'],
            ['Personal data we collect', 'Identity and contact details; national ID / NIDA; face verification images you capture; financial and credit information; payment transaction data; device and usage records needed for security; support records; and optional marketing preferences where you opt in.'],
            ['Device permissions', 'For KYC we request only camera access or files you select through the system file picker. We do not access contacts, SMS inbox, call logs, or social media accounts on your device. You may switch between front and back cameras when capturing.'],
            ['Purposes', 'We process data to create and secure accounts, assess credit and AML risk, service loans and membership, send transactional messages (OTP, USSD, e-receipts, reminders), and improve service safety. Marketing only where allowed.'],
            ['Data residency', 'Borrower and member personal data for our Tanzania licensed entity is intended to be hosted and primarily processed in systems supporting operations in the United Republic of Tanzania. Limited overseas access may occur only for maintenance, cloud infrastructure, or licensed processors under confidentiality and data-protection terms consistent with PDPA Parts V–VI (transborder flow). Where required, we will seek PDPC permission for transfers to states without adequate protection.'],
            ...
            ['Retention and security', 'We retain records for the relationship and statutory periods, then delete or anonymise where feasible. We use access controls, encryption in transit, and PIN/password protections. A Data Protection Officer (DPO) contact will be published once appointed; until then use :email.'],
            ['Automated decisions', 'Credit decisions may use automated scoring together with human underwriting review. Under the PDPA you may request information about significant solely automated decisions that affect you and, where the Act requires, seek human intervention.'],
            ['Your rights under PDPA', 'Subject to the PDPA you may request access, correction, deletion/erasure, restriction or blocking, objection to processing likely to cause damage, and opt-out of direct marketing. You may also lodge a complaint with the Personal Data Protection Commission (PDPC) under the Personal Data Protection (Complaints Settlement Procedures) Regulations, 2023. Use Support or email :email.'],
