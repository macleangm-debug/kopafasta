...
return [
    ...
    'privacy' => [
        ...
        'sections' => [
            ...
            ['Legal basis (PDPA)', 'We process personal data where necessary to perform a contract with you (membership, loans, repayments), to comply with legal obligations (KYC/AML, BoT, credit reporting), with your consent where required (e.g. optional marketing), and for legitimate interests that do not override your rights (fraud prevention, platform security).'],
            ...
            ['Device permissions', 'For KYC we request only camera access or files you select through the system file picker. We do not access contacts, SMS inbox, call logs, or social media accounts on your device.'],
            ...
            ['Data residency', 'Borrower and member personal data for our Tanzania licensed entity is intended to be hosted and primarily processed in systems supporting operations in the United Republic of Tanzania. Limited overseas access may occur only for maintenance, cloud infrastructure, or licensed processors under confidentiality and data-protection terms consistent with PDPA.'],
            ...
            ['Your rights under PDPA', 'Subject to the PDPA, you may request access, correction, deletion, restriction, or objection, and withdraw consent where processing is consent-based. You may also lodge a complaint with the Personal Data Protection Commission (PDPC). Use Support or email :email.'],
