...
class Phase65RecoveryPhase2FeatureTest extends TestCase
{
    ...
    public function test_admin_can_save_recovery_sla_matrix(): void
    {
        ...
        $response = $this->actingAs($admin, 'admin')->put(route('admin.settings.recovery.save'), [
            ...
            'sla_days_towing' => 3,
            'commission_percent_towing' => 0,
            'markup_percent_towing' => 10,
            'has_markup_towing' => 1,
            'fee_type_towing' => 'fixed',
            'fixed_amount_towing' => '',
            'priority_towing' => 6,
            'loan_types_towing' => 'all',
            'collateral_scope_towing' => 'secured',
            'auto_escalate_type_towing' => 0,
            'sla_days_yard' => 30,
            'commission_percent_yard' => 0,
            'markup_percent_yard' => 10,
            'has_markup_yard' => 1,
            'fee_type_yard' => 'fixed',
            'fixed_amount_yard' => '',
            'priority_yard' => 7,
            'loan_types_yard' => 'all',
            'collateral_scope_yard' => 'secured',
            'auto_escalate_type_yard' => 0,
            'yard_partner_daily_rate' => '',
            'yard_markup_type' => 'percent',
            'yard_markup_percent' => 10,
            'yard_has_markup' => 1,
