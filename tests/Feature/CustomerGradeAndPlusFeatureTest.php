...
class CustomerGradeAndPlusFeatureTest extends TestCase
{
    ...
    public function test_hero_and_plus_follow_grade_access_and_hide_application_tracking(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertSee('kf-premium-panel', false)
            ->assertDontSee(__('plus.home.optional_chip'), false)
            ->assertDontSee(__('plus.home.join_disclosure'), false)
            ->assertDontSee(__('plus.home.not_required_title'), false)
            ->assertDontSee(__('plus.learn.this_month'), false)
