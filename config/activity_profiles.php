...
return [
    ...
    'fields' => [
        ...
        'artisan' => [
            ['key' => 'skill_type', 'label' => 'Craft / trade type', 'type' => 'select', 'options' => [
                'tailor'        => 'Tailor',
                'barber'        => 'Barber',
            ...
            ['key' => 'region', 'label' => 'Workshop region', 'type' => 'region', 'required' => true],
            ['key' => 'district', 'label' => 'Workshop district', 'type' => 'district', 'required' => true],
            ['key' => 'ward', 'label' => 'Ward', 'type' => 'text', 'required' => false],
            ['key' => 'street', 'label' => 'Workshop street / address', 'type' => 'text', 'required' => true],
        ],
        'student' => [
