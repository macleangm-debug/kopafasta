...
return [
    'modules' => [
        ...
        'UND' => ['loan-applications', 'customer-kycs', 'face-verifications', 'guarantors', 'teams.screening'],
        'CRC' => ['loan-applications', 'loans', 'reports', 'teams.committee'],
        ...
        'CRM' => ['loan-applications', 'loans', 'customers', 'repayments', 'reports', 'teams.management'],
