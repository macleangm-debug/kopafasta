...
return [
    'modules' => [
        ...
        'COL' => ['loans.arrears', 'arrear-cases', 'write-off-requests', 'restructure-requests', 'top-up-requests', 'reports.arrears', 'reports.par'],
        ...
        'REC' => ['arrear-cases', 'loans.arrears', 'loans.closed', 'write-off-requests', 'reports.arrears', 'reports.npl'],
