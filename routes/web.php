...
Route::name('site.')->middleware(\App\Http\Middleware\SetLocale::class)->group(function () {
    ...
    Route::middleware('auth:web')->group(function () {
        ...
        Route::middleware('borrower.pin')->group(function () {
            ...
            Route::get('/borrower/plus/money', [\App\Http\Controllers\Site\PlusController::class, 'money'])->name('borrower.plus.money');
            Route::post('/borrower/plus/money', [\App\Http\Controllers\Site\PlusController::class, 'saveMoney'])->name('borrower.plus.money.save');
            Route::get('/borrower/plus/business', [\App\Http\Controllers\Site\PlusController::class, 'business'])->name('borrower.plus.business');
            Route::post('/borrower/plus/business', [\App\Http\Controllers\Site\PlusController::class, 'saveBusiness'])->name('borrower.plus.business.save');
            ...
            Route::post('/borrower/applications/{application}/collateral-secure/ask-members', [\App\Http\Controllers\Site\CollateralSecureController::class, 'borrowerAskMembers'])->name('borrower.collateral-secure.ask-members');
