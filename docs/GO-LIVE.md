...
- **Never** restore staging or triptz dumps into production. Use `scripts/init-production-database.sh` on an empty production database, then `production:assert-clean`.
