...
**Live platform (intended production domain):** https://www.kopafasta.com  
...
|------|-------------------------------|--------------------|
| 1. Ownership on landing | https://www.kopafasta.com/ → hero disclosure card | “This Digital Lending Platform is owned or operated by [legal name].” |
...
| 4. Privacy / PDPA | https://www.kopafasta.com/legal/privacy | PDPA basis, biometric consent, residency, PDPC complaint rights. |
| 5. TZ / TZS only | https://www.kopafasta.com/register/borrower | Only Tanzania / +255; amounts in TZS. |
| 6. Pricing + penalties | https://www.kopafasta.com/loans → product → **Fees** | Fees + late penalty **before** Apply. |
...
| Live link | Pass | Ops | https://www.kopafasta.com/ · `/loans` |
