...
class PublicLoanProductsSeeder extends Seeder
{
    public function run(): void
    {
        $products = [
            ...
            ['code' => 'GL', 'name' => 'Group Loan',        'category' => 'group',       'interest_rate' => 0.18,  'min_amount' => 50000,   'max_amount' => 10000000, 'tenure_min_months' => 1, 'tenure_max_months' => 12, 'repayment_cadence' => 'monthly', 'description' => 'Borrow together with shared liability. Best for chamas and savings circles.'],
