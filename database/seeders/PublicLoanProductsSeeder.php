...
class PublicLoanProductsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $products = [
            ...
            ['code' => 'SAL-12', 'name' => 'Salary Advance', 'name_sw' => 'Mkopo wa Nivushe', 'category' => 'salary_loan', 'interest_rate' => 0.035, 'min_amount' => 200_000, 'max_amount' => 5000000, 'tenure_min_months' => 1, 'tenure_max_months' => 12, 'description' => 'Payroll-deducted salary advance for salaried employees.', 'status' => 'coming_soon'],
        ];
