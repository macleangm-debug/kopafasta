...
@php
    $sections = [
        ...
        ['Lending', 'M3 10h18M3 14h18M5 6h14M5 18h14', [
            ...
            ['Credit teams',          'admin.credit-team.index'],
        ...
        ['Money', 'M12 8c-1.66 0-3 .9-3 2s1.34 2 3 2 3 .9 3 2-1.34 2-3 2m0-8v8m0 0v2m-9-5a9 9 0 1018 0 9 9 0 00-18 0z', [
            ...
            ['Membership payments',   'admin.membership-payments.index',   'membership.approve_payments'],
            ['Expenses',              'admin.expenses.index',              'finance.operations'],
            ['Payment gateway settlements', 'admin.settlements.index',       'finance.operations'],
            ['Partner payouts (approve)',   'admin.partner-payments.index',        'finance.operations'],
            ['Partner settlements (batch)', 'admin.partner-settlements.index',     'finance.operations'],
            ['Partner payout requests',     'admin.partner-payout-requests.index', 'finance.operations'],
