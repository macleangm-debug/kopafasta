...
>
    ...
    <div class="px-4 py-3.5 flex flex-col flex-1">
        ...
        <h3 class="mt-1 text-lg font-extrabold text-brand leading-snug tracking-tight group-hover:text-brand-light transition-colors line-clamp-2 min-h-[2.75rem]" title="{{ $productName }}">
            {{ $productName }}
        </h3>
        <p class="mt-0.5 text-sm text-gray-600 line-clamp-2 min-h-[2.5rem] leading-snug">{{ $description }}</p>
