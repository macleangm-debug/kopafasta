...
>
    ...
    <div class="px-4 py-3.5 flex flex-col flex-1">
        ...
        <h3 class="text-lg font-extrabold text-brand leading-snug tracking-tight mt-0.5 group-hover:text-brand-light transition-colors line-clamp-2" title="{{ $productName }}">
            {{ $productName }}
        </h3>
