...
@endphp
<div x-data="siteHelpHub(@js($chatbot))" x-cloak>
    {{-- Launcher --}}
    <div class="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
        ...
        <div x-show="menuOpen && !chatOpen" x-transition.opacity.scale.95
            ...
            <div class="p-2">
                <button type="button" @click="openChat()"
                    ...
                    <span>
                        <span class="block text-sm font-semibold text-gray-900">{{ __('site.support.assistant_title') }}</span>
        ...
        <div x-show="chatOpen" x-transition.opacity.scale.95
            ...
            <div class="bg-brand text-white px-4 py-3 flex items-center gap-3">
                ...
                <button type="button" @click="chatOpen = false; menuOpen = false" class="p-1.5 rounded-lg hover:bg-white/10" aria-label="Close">
        ...
        <button type="button" @click="toggleMenu()"
                ...
                :aria-expanded="menuOpen || chatOpen" aria-label="{{ __('site.help_hub.title') }}">
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('siteHelpHub', (chatbot) => ({
            menuOpen: false,
            chatOpen: false,
            input: '',
