                ...
                <div class="mb-6 text-left">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <template x-for="(step, i) in steps" :key="'intro-' + step.key">
                            <div class="rounded-2xl overflow-hidden ring-1 ring-gray-200 bg-white shadow-sm">
                                ...
                                <div x-show="step.done" class="p-2 flex gap-2 border-t border-gray-100">
                                    <button type="button" @click="retakeStep(i)" :disabled="isRemoving"
                                            class="flex-1 text-[11px] font-semibold px-2 py-2 rounded-xl bg-gray-100 hover:bg-gray-200 text-gray-800 disabled:opacity-50">
