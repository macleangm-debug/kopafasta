...
@php
    ...
    $selectClass = $selectClass ?? ($variant === 'rounded'
        ? 'w-28 shrink-0 px-3 py-2.5 rounded-xl bg-white border border-gray-200 text-sm outline-none transition focus:border-brand focus:ring-2 focus:ring-brand/10'
    ...
    $inputClass = $inputClass ?? ($variant === 'rounded'
        ? 'flex-1 px-3 py-2.5 rounded-xl bg-white border border-gray-200 focus:border-brand focus:ring-2 focus:ring-brand/10 text-sm outline-none transition'
    ...
    $prefixDisplayClass = $variant === 'rounded'
        ? 'w-28 shrink-0 px-3 py-2.5 rounded-xl bg-gray-50 border border-gray-200 text-sm text-gray-700 font-medium inline-flex items-center justify-center select-none'
