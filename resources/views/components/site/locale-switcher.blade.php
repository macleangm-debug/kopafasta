...
<div x-data="{ localeOpen: false, mobileLocaleOpen: false }" class="flex items-center gap-2">
...
<div class="{{ $isHeader ? 'flex items-center gap-2' : 'flex flex-col gap-3' }}"
     x-data="{ {{ $showCountry ? 'countryOpen: false, mobileCountryOpen: false, ' : '' }}localeOpen: false, mobileLocaleOpen: false }"
     @keydown.escape.window="{{ $showCountry ? 'countryOpen = false; mobileCountryOpen = false; ' : '' }}localeOpen = false; mobileLocaleOpen = false">
    ...
    <div class="hidden lg:flex items-center gap-2">
        ...
        @endif
        <div class="relative">
            <button type="button" @click="localeOpen = !localeOpen{{ $showCountry ? '; countryOpen = false' : '' }}"
