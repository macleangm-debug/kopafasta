<div>
<x-admin.table-shell :records="$rows" :statuses="$statuses" searchPlaceholder="Search vendor or task type…">
    <x-slot:headers>
    ...
    <x-slot:rows>
        ...
        @empty
            <tr><td colspan="5" class="px-5 py-12 text-center text-gray-500">No vendor tasks found.</td></tr>
        @endforelse
    </x-slot:rows>
</x-admin.table-shell>
</div>
