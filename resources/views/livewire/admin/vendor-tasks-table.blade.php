            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-5 py-3 text-xs text-gray-600">
                    @if ($r->loanApplication)
                        <a href="{{ route('admin.loan-applications.show', $r->loanApplication) }}" class="text-brand hover:underline">
                            App #{{ $r->loanApplication->application_number ?? $r->loanApplication->id }}
                        </a>
                    @elseif ($r->loan)
                        <a href="{{ route('admin.loans.show', $r->loan) }}" class="text-brand hover:underline">
