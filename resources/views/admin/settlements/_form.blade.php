...
<x-admin.step title="Amounts">
    <x-admin.input  name="gross_amount"        label="Gross amount"       :value="$r?->gross_amount" money required />
    <x-admin.input  name="fees"                label="Fees"               :value="$r?->fees" money />
    <x-admin.input  name="net_amount"          label="Net amount"         :value="$r?->net_amount" money help="Auto-calculated if blank" />
