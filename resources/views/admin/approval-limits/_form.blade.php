...
<x-admin.step title="Approval limit">
    ...
    <x-admin.input  name="min_amount" label="Min amount" type="number" step="0.01" :value="$r?->min_amount ?? '0'" required />
    <x-admin.input  name="max_amount" label="Max amount" type="number" step="0.01" :value="$r?->max_amount" required />
