<x-admin.show-page
    ...
    :fields="[
        ...
        'Amount committed' => $record->amount_committed !== null ? format_number((float) $record->amount_committed) : null,
        'Amount deployed'  => $record->amount_deployed  !== null ? format_number((float) $record->amount_deployed)  : null,
