<x-admin.layout title="Notification Templates" heading="Notification Templates" subheading="Message copy by stage — registration, application, repayment, late payment…">
