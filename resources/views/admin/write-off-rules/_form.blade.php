...
<x-admin.step title="Write-off rule">
    ...
    <x-admin.input  name="min_outstanding" label="Min outstanding" money :decimals="2" :value="$r?->min_outstanding" />
    <x-admin.input  name="max_outstanding" label="Max outstanding" money :decimals="2" :value="$r?->max_outstanding" />
