...
<x-admin.step title="Fee definition">
    ...
    <x-admin.input  name="amount" label="Amount / rate" money :decimals="4" :value="$r?->amount ?? '0'" required
                    help="For percentage, enter 2 for 2%. For fixed, enter TZS amount." />
    <x-admin.input  name="min_amount" label="Min amount" money :decimals="2" :value="$r?->min_amount" />
    <x-admin.input  name="max_amount" label="Max amount" money :decimals="2" :value="$r?->max_amount" />
