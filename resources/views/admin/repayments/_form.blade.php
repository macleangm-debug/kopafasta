...
<x-admin.step title="Payment">
    ...
    <x-admin.input  name="amount"                label="Amount"           :value="$r?->amount" type="number" required />
    <x-admin.input  name="paid_at"               label="Paid at"          :value="optional($r?->paid_at)->format('Y-m-d')" type="date" />
</x-admin.step>

<x-admin.step title="Allocation">
    <x-admin.input  name="principal_component"   label="Principal"        :value="$r?->principal_component" type="number" />
    <x-admin.input  name="interest_component"    label="Interest"         :value="$r?->interest_component"  type="number" />
    <x-admin.input  name="penalty_component"     label="Penalty"          :value="$r?->penalty_component"   type="number" />
