<x-admin.layout
    ...
    heading="Pending partner onboarding"
    subheading="Inactive partners awaiting activation. Enrollment applications from the public form are reviewed separately.">
