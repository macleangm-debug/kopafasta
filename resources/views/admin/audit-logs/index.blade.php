            ...
            <tbody class="divide-y divide-gray-100">
                @forelse ($logs as $log)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-5 py-2"><span class="rounded bg-indigo-50 text-indigo-700 px-2 py-0.5 text-xs">{{ $log->event }}</span></td>
                        ...
                        <td class="px-5 py-2 text-right"><a href="{{ route('admin.audit-logs.show', $log->id) }}" class="text-xs font-semibold text-indigo-600 hover:text-indigo-700">View</a></td>
                    </tr>
                @empty
