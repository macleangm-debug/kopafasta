                    ...
                    @forelse ($requests as $request)
                        ...
                        <tr class="hover:bg-gray-50 align-top">
                            <td class="px-5 py-3 font-mono text-xs font-semibold">
                                <a href="{{ route('admin.restructure-requests.show', $request) }}" class="text-brand hover:text-brand-light">
                                    {{ $loan?->loan_number ?? '—' }}
                                </a>
                            </td>
                            <td class="px-5 py-3">
                            ...
                            <td class="px-5 py-3 text-right">
                                <a href="{{ route('admin.restructure-requests.show', $request) }}" class="text-brand font-semibold text-xs hover:underline">Review</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
