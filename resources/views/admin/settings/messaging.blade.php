<x-admin.layout title="Transactional messaging" heading="Transactional messaging" subheading="Turn automated SMS, email, in-app and WhatsApp on or off per event">
    ...
    <x-admin.settings-editor
        action="{{ route('admin.settings.messaging.save') }}"
        submit-label="Save messaging settings"
        :tabs="[
            'global' => 'Global',
            'channels' => 'Channels',
            'whatsapp' => 'WhatsApp',
    ...
    >
        <x-admin.settings-panel id="global">
        ...
        <x-admin.settings-panel id="channels">
        ...
        <x-admin.settings-panel id="whatsapp">
            <div class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-6">
        ...
        <x-admin.settings-panel id="events">
