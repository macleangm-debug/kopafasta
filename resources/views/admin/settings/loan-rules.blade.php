<x-admin.layout title="Loan Rules" heading="Loan Rules" subheading="Defaults applied to new loans">
    ...
    <x-admin.settings-editor
        action="{{ route('admin.settings.loan-rules.save') }}"
        submit-label="Save loan rules"
        :tabs="[
            'grace' => 'Grace & penalty',
            'tenure' => 'Tenure',
    ...
    >
        ...
        <x-admin.settings-panel id="tenure">
            <div class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-6">
            ...
            <div class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <label class="flex items-center gap-2 text-sm bg-gray-50 ring-1 ring-gray-200 rounded-lg px-3 py-2 md:col-span-3">
                        ...
                        <input type="checkbox" name="allow_asset_reuse" value="1" @checked(!empty($values['allow_asset_reuse'])) class="size-4 rounded border-gray-300 text-brand focus:ring-brand">
        ...
        <x-admin.settings-panel id="restructuring">
            <div class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-6">
                <h3 class="text-sm font-semibold text-gray-700 mb-4">Restructuring</h3>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <label class="flex items-center gap-2 text-sm bg-gray-50 ring-1 ring-gray-200 rounded-lg px-3 py-2 md:col-span-3">
                        <input type="hidden" name="allow_restructure" value="0">
                        <input type="checkbox" name="allow_restructure" value="1" @checked(array_key_exists('allow_restructure', $values) ? ! empty($values['allow_restructure']) : false) class="size-4 rounded border-gray-300 text-brand focus:ring-brand">
                    ...
                    <label class="flex items-center gap-2 text-sm bg-gray-50 ring-1 ring-gray-200 rounded-lg px-3 py-2 md:col-span-3">
                        ...
                        <input type="checkbox" name="payment_holiday_accrue_interest" value="1" @checked(! isset($values['payment_holiday_accrue_interest']) || ! empty($values['payment_holiday_accrue_interest'])) class="size-4 rounded border-gray-300 text-brand focus:ring-brand">
        ...
        <x-admin.settings-panel id="qualification">
            <div class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-6">
        ...
        <x-admin.settings-panel id="group">
