<nav class="sticky top-14 z-30 -mx-1 mb-6 bg-gray-50/95 backdrop-blur border-y border-gray-200 py-2 px-1" aria-label="Customer sections">
    <div class="flex gap-1 overflow-x-auto">
        @foreach ([
            ...
            ['#customer-guarantor-requests', 'Guarantors'],
        ] as [$href, $label])
            <a href="{{ $href }}"
