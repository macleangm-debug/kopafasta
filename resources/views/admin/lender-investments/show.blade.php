<x-admin.show-page
    ...
    :fields="[
        ...
        'Principal'      => $record->principal     !== null ? number_format((float) $record->principal)     : null,
        'Return amount'  => $record->return_amount !== null ? number_format((float) $record->return_amount) : null,
