<x-admin.review-section id="review-documents" title="Uploaded documents" subtitle="Product checklist files already on this application — review these first" collapsible :open="true">
