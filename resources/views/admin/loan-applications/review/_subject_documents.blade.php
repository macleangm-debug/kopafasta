...
<section class="rounded-2xl ring-1 ring-brand/10 bg-white overflow-hidden">
    <div class="px-5 py-4 border-b border-brand/10 bg-gradient-to-r from-brand-muted/40 to-white">
        ...
        <h2 class="text-sm font-semibold text-gray-900 mt-0.5">Profile &amp; KYC uploads</h2>
        <p class="text-xs text-gray-500 mt-0.5">Identity and profile documents for this guarantor — not the borrower’s product checklist.</p>
    </div>
    <div class="p-5">
        @if ($docs->isEmpty())
