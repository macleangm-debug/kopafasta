<x-admin.layout title="Interest & Fees" heading="Interest & Fees" subheading="Pricing summary across all loan products">
        ...
        <table class="min-w-full text-sm">
            <thead class="bg-gray-50 text-xs uppercase tracking-wider text-gray-500">
                <tr>
                    ...
                    <th class="px-5 py-2.5 text-right">Interest rate</th>
            ...
            <tbody class="divide-y divide-gray-100">
                @forelse ($products as $p)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-5 py-3 text-right font-semibold">{{ number_format((float) $p->interest_rate * 100, 2) }} %</td>
    ...
    <p class="mt-4 text-xs text-gray-500">
        Fee schedule (origination, late, processing) is managed per product on the product edit page.
    </p>
</x-admin.layout>
