<x-admin.show-page
    ...
    :fields="[
        ...
        'System total'  => $record->system_total !== null ? format_number((float) $record->system_total) : null,
        'Bank total'    => $record->bank_total   !== null ? format_number((float) $record->bank_total)   : null,
        'Variance'      => $record->variance     !== null ? format_number((float) $record->variance)     : null,
