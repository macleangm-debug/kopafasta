...
<div class="mb-6" x-data="{ sectionsOpen: false }">
    @if ($portal === 'supplier')
    <nav class="flex gap-2 overflow-x-auto snap-x snap-mandatory scrollbar-none pb-1 -mx-1 px-1 scroll-smooth" aria-label="{{ __('site.partner_account.sections_title') }}">
