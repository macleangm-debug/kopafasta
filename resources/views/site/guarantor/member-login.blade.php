...
<x-site.guarantor-invite-shell
    ...
    :eyebrow="__('borrower.guarantor_invite.member_login_title')"
    :heading="__('borrower.guarantor_invite.member_login_title')"
    :lede="__('borrower.guarantor_invite.member_login_subtitle', ['borrower' => $borrowerName])"
>
    <h1 class="text-2xl font-bold tracking-tight mb-2">{{ __('borrower.guarantor_invite.member_login_title') }}</h1>
