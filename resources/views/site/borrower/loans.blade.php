<x-site.borrower-layout title="My loans — Kopafasta" active="loans">
    ...
    <p class="text-sm text-gray-500 mb-6">Active and historical loans.</p>
            ...
            @foreach ($loans as $loan)
                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-6">
                    ...
                    <div class="flex items-center gap-2 flex-wrap">
                        ...
                        <button type="button" class="text-xs text-gray-500 hover:text-gray-700 px-3 py-2">Download agreement (PDF)</button>
                    </div>
                </div>
            @endforeach
        </div>
