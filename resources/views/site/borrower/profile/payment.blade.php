    ...
    <div>
        ...
        <div class="glass-card overflow-hidden">
            <div class="px-5 sm:px-6 py-4 border-b border-gray-100/80 flex flex-wrap items-start justify-between gap-3">
                <div>
                    <h2 class="font-semibold text-gray-900">{{ __('borrower.payment_details.section_title') }}</h2>
                    @if ($paymentComplete)
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    @foreach ($group['items'] as $account)
                                        <div class="rounded-2xl ring-1 ring-gray-200 px-4 py-3 flex flex-wrap items-start justify-between gap-3 {{ $account->is_default ? 'bg-emerald-50/40 ring-emerald-200' : 'bg-white' }}">
                                            <div class="min-w-0">
