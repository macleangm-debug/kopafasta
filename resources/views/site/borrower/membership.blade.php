        ...
        @if ($customer && $referralCode)
            <section class="mb-8 bg-brand text-white rounded-2xl p-5 sm:p-6 shadow-lg relative overflow-hidden">
                ...
                <div class="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <a href="{{ route('site.borrower.engagement', ['tab' => 'referrals']) }}" class="shrink-0 inline-flex bg-brand-gold hover:bg-yellow-400 text-brand font-bold px-5 py-2.5 rounded-xl text-sm">{{ __('borrower.membership_page.open_referrals') }}</a>
                </div>
            </section>
        @endif
    @else
