...
<section class="glass-card p-6 flex flex-col">
    ...
    <p class="mt-3 text-4xl font-black text-brand tabular-nums leading-none">{{ number_format(wallet_balance_as_points($referralWallet->balance ?? 0)) }}</p>
...
@if (($level['benefits'] ?? []) !== [])
    <section class="lg:col-span-3 glass-card p-6">
