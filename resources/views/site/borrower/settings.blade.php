    ...
    <div>
        ...
        <div class="space-y-6">
            ...
            <div class="glass-card p-5 sm:p-6">
                <h2 class="font-semibold text-gray-900">{{ __('borrower.settings.personalisation_title') }}</h2>
                <p class="mt-1 text-sm text-gray-600">{{ __('borrower.settings.personalisation_hint') }}</p>
                <ul class="mt-4 space-y-2 text-sm text-gray-700 list-disc list-inside">
                    <li>{{ __('borrower.settings.personalisation_items.language') }}</li>
                    <li>{{ __('borrower.settings.personalisation_items.display_name') }}</li>
                    <li>{{ __('borrower.settings.personalisation_items.preferred_channel') }}</li>
                    <li>{{ __('borrower.settings.personalisation_items.quiet_hours') }}</li>
                </ul>
            </div>
        </div>
    </div>
