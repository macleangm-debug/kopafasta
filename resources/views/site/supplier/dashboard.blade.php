<x-site.supplier-layout title="Supplier dashboard" active="dashboard">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        @foreach ([['Assets', $stats['assets']], ['Active reservations', $stats['reservations']], ['Open requests', $stats['requests']], ['Pending payouts', 'TZS '.format_number($stats['pending_pay'])]] as [$label, $value])
