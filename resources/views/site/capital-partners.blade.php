<x-site.layout title="Capital partners — Kopafasta institutional programme"
    ...
    <section class="relative overflow-hidden bg-brand text-white">
        ...
        <div class="absolute inset-0 opacity-15" style="background-image: radial-gradient(circle at 15% 20%, #f5c842 0%, transparent 45%), radial-gradient(circle at 85% 75%, #0d5c4d 0%, transparent 45%);"></div>
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 grid lg:grid-cols-5 gap-12 items-center">
            <div class="text-white lg:col-span-3">
                <p class="text-xs uppercase tracking-widest text-brand-gold mb-4">Capital partner programme</p>
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-tight">
                    Institutional capital, <br><span class="text-brand-gold">deployed with discipline.</span>
                </h1>
                ...
                <div class="mt-8 flex flex-wrap gap-3">
                    <a href="{{ route('site.register.capital') }}" class="inline-flex items-center gap-2 bg-brand-gold hover:bg-yellow-400 text-brand font-semibold px-6 py-3 rounded-full shadow-lg transition">
                        Apply as partner
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <p class="text-xs uppercase tracking-widest text-brand mb-2">Built for institutions</p>
        ...
        <div class="mt-10 grid md:grid-cols-2 lg:grid-cols-5 gap-5">
            @foreach ([
                ...
                <div class="rounded-2xl border border-slate-200 hover:border-brand hover:shadow-lg p-6 transition bg-white">
                    <div class="size-11 grid place-items-center rounded-xl bg-brand-muted text-2xl mb-3">{{ $icon }}</div>
    ...
    <section class="bg-slate-50 border-t border-b border-slate-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <p class="text-xs uppercase tracking-widest text-brand mb-2">Programme structure</p>
            ...
            <div class="mt-10 grid md:grid-cols-3 gap-6">
                @foreach ([
                    ...
                    <div class="rounded-3xl bg-white border-2 border-slate-200 hover:border-brand hover:shadow-xl transition p-7">
                        ...
                        <dl class="mt-6 grid grid-cols-2 gap-3 text-xs">
                            <div class="rounded-lg bg-brand-muted/50 p-3">
                                <dt class="text-brand font-semibold uppercase tracking-wider text-[10px]">Ticket size</dt>
    ...
    {{-- WHAT YOU GET --}}
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <p class="text-xs uppercase tracking-widest text-brand mb-2">What you get</p>
        ...
        <div class="mt-12 grid md:grid-cols-3 gap-6">
            @foreach ([
                ...
                <div class="rounded-2xl border border-slate-200 hover:border-brand hover:shadow-lg p-6 transition bg-white">
                    <div class="size-11 grid place-items-center rounded-xl bg-brand-muted text-2xl mb-4">{{ $icon }}</div>
    ...
    <section class="bg-slate-50 border-t border-b border-slate-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <p class="text-xs uppercase tracking-widest text-brand mb-2">Onboarding</p>
            ...
            <ol class="mt-10 grid md:grid-cols-4 gap-6">
                @foreach ([
                    ...
                    <li class="relative rounded-2xl border border-slate-200 p-6 bg-white">
                        <span class="absolute -top-3 left-6 text-[11px] font-bold uppercase tracking-widest px-2 py-1 rounded-full bg-brand-600 text-white">{{ $w }}</span>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid lg:grid-cols-2 gap-12 items-center">
        <div>
            <p class="text-xs uppercase tracking-widest text-brand mb-2">Governance &amp; controls</p>
            ...
            <ul class="mt-6 space-y-3 text-sm text-slate-700">
                <li class="flex gap-3"><span class="text-brand font-bold">·</span> Independent board with majority non-executive directors</li>
                <li class="flex gap-3"><span class="text-brand font-bold">·</span> Big-4 audited financials (KPMG) — available on request</li>
                <li class="flex gap-3"><span class="text-brand font-bold">·</span> Quarterly investment-committee minutes shared with partners</li>
                <li class="flex gap-3"><span class="text-brand font-bold">·</span> ISO 27001 certified information security</li>
                <li class="flex gap-3"><span class="text-brand font-bold">·</span> Sanctions, PEP &amp; adverse-media screening on every borrower</li>
                <li class="flex gap-3"><span class="text-brand font-bold">·</span> Recovery infrastructure: 12 collection partners, 7 yards, GPS-tracked assets</li>
            </ul>
        </div>
        <div class="rounded-3xl bg-gradient-to-br from-brand-700 to-slate-900 text-white p-8 lg:p-10">
            ...
            <a href="mailto:capital@kopafasta.com?subject=Data%20room%20request" class="mt-8 inline-flex items-center gap-2 text-sm font-semibold text-brand-200 hover:text-white">
    ...
    <section class="bg-slate-50 border-t border-b border-slate-200">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <p class="text-xs uppercase tracking-widest text-brand mb-2">Common questions</p>
    ...
    {{-- CTA --}}
    <section class="bg-gradient-to-br from-brand-800 to-slate-900">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center text-white">
            ...
            <div class="mt-7 flex flex-wrap gap-3 justify-center">
                <a href="{{ route('site.register.capital') }}" class="bg-white text-brand-800 hover:bg-brand-muted/50 font-semibold px-6 py-3 rounded-full">Apply as capital partner</a>
