<x-site.investor-layout title="Support — Investor" active="support">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="glass-card rounded-2xl ring-1 ring-brand/10 p-6">
            ...
            <p class="text-sm text-gray-500 mt-1">Personal advisor for large capital partners.</p>
        ...
        <div class="glass-card rounded-2xl ring-1 ring-brand/10 p-6">
            ...
            <p class="text-sm text-gray-500 mt-1">investors@kopafasta.com — replies within 1 business day.</p>
            <a href="mailto:investors@kopafasta.com" class="mt-3 inline-flex items-center gap-2 rounded-lg border border-gray-200 hover:bg-brand-muted/30 font-semibold px-4 py-2 text-sm">Send email</a>
        </div>
        <div class="glass-card rounded-2xl ring-1 ring-brand/10 p-6">
            ...
            <p class="text-sm text-gray-500 mt-1">Questions about pools, terms or pricing.</p>
            <a href="{{ route('site.faq') }}" class="mt-3 inline-flex items-center gap-2 rounded-lg border border-gray-200 hover:bg-brand-muted/30 font-semibold px-4 py-2 text-sm">Browse FAQ</a>
        </div>
        <div class="glass-card rounded-2xl ring-1 ring-brand/10 p-6">
            ...
            <p class="text-sm text-gray-500 mt-1">Track issues with our support team.</p>
            <a href="mailto:support@kopafasta.com" class="mt-3 inline-flex items-center gap-2 rounded-lg border border-gray-200 hover:bg-brand-muted/30 font-semibold px-4 py-2 text-sm">New ticket</a>
        </div>
    </div>
