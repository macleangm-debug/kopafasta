                        ...
                        <fieldset>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input name="phone" value="{{ old('phone') }}" required placeholder="+255 7XX XXX XXX" class="w-full px-3.5 py-3 rounded-xl bg-white border border-slate-300 focus:border-indigo-600 focus:ring-4 focus:ring-indigo-600/10 text-sm outline-none" />
                                </div>
                            </div>
                            <div class="mt-4">
