...
@if ($kpi)
    <div class="{{ $compact ? 'mb-5' : 'mb-6' }} rounded-2xl border border-indigo-200 bg-gradient-to-br from-indigo-50 to-white p-5 sm:p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
            ...
            <a href="{{ route('site.partner.recovery-wallet') }}" class="text-sm font-semibold text-indigo-600 hover:underline shrink-0">
                Commission wallet →
            </a>
        </div>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-5 gap-3">
            @foreach ([
                ...
                <div class="rounded-xl bg-white ring-1 ring-indigo-100 p-3">
        ...
        @if ($wallet)
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4 pt-4 border-t border-indigo-100">
