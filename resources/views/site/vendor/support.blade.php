<x-site.vendor-layout title="Support" active="support">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <a href="mailto:vendors@kopafasta.test" class="rounded-2xl border border-gray-200 bg-white p-5 hover:shadow-sm">
        ...
        <a href="{{ route('site.faq') }}" class="rounded-2xl border border-gray-200 bg-white p-5 hover:shadow-sm">
