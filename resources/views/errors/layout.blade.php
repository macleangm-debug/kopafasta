@php
    if (in_array(request('lang'), ['sw', 'en'], true)) {
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        main { flex:1; display:grid; place-items:center; padding:1.5rem; }
        ...
        footer { text-align:center; font-size:11px; color:#9ca3af; padding:1rem; }
    ...
    <main>
        <div class="card">
            ...
            <div class="actions">
                ...
                <a class="btn ghost" href="{{ $support }}">{{ __('errors.support') }}</a>
            </div>
