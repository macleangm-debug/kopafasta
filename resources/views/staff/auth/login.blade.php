...
<div class="min-h-full grid lg:grid-cols-2">
    <aside class="relative hidden lg:flex flex-col justify-between overflow-hidden bg-brand text-white px-10 py-12"
        ...
        <div class="relative">
            ...
            <p class="mt-3 text-xs uppercase tracking-[0.2em] text-white/60">Staff workspace</p>
            ...
            <p class="mt-4 text-sm text-white/70 max-w-sm">Secure access for credit, collections, and operations teams.</p>
        </div>
