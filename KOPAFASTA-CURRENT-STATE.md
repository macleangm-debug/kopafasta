...
| **Current staging / development baseline** | _(set after Identity closure deploy)_ | Linear descendant of production history. Contains `73fbbbfe`. Identity closure: NIDA no-Edit, Front→Back directive journey, autosave spinner. **Do not push this mixed tip to `origin/main` yet.** |
